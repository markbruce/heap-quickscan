...
# attribute ANY number of objects instantly. Needs heap ~ 22 bytes per heap
# object (e.g. -Xmx8g..10g for a 229M-object dump); on smaller heaps drop the
# flag and paths falls back to a shared multi-target BFS sweep (no extra
# memory, a few minutes for all suspects together).
java -Xmx10g -cp target HeapQuickScan paths --parents /path/to/dump.hprof 0x631719d20 0x7d1800000
```
